def create_vote(vote_repository: object, estimateid: str, nickname: str, voteid, vote_data: dict,
...
formatted_user_story_list, formatted_estimate_list, formatted_vote_list) -> dict:
    try:
        ...
        updated_room = vote_repository.create(room_name, estimateid, nickname, vote_data)
